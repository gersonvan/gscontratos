class ProfessionsController < ApplicationController
  ...
  def index
    ...
    @professions = Profession.order :profissao
    render "index"
  end
  ...
  def create
    ...
    respond_to do |format|
      if @profession.save
        format.html { redirect_to action: 'index', notice: 'Profissão criada com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @profession.update(profession_params)
        format.html { redirect_to action: 'index', notice: 'Profissão alterada com sucesso.' }
  ...
  def destroy
    @profession.destroy
    respond_to do |format|
      format.html { redirect_to professions_url, notice: 'Profissão apagada com sucesso.' }
  ...
  private
    ...
    def profession_params
      params.require(:profession).permit(:profissao)
    end
end
